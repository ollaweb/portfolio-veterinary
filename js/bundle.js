...
function burger() {
  ...
  var burgerStrips = document.querySelector(".burger__items");
  var menu = document.querySelector(".menu");
  var menuOverlay = document.querySelector(".menu-overlay");
  var menuItem = document.querySelectorAll(".menu__item a");
  var spoiler = document.querySelector(".spoiler");
  var headerLocation = document.querySelector(".header__location");
...
function modal() {
  function applyModalWindowToButton(btnModal, classModal) {
    var modalBtn = document.querySelector(btnModal);
    var modalClass = document.querySelector(classModal);
    var scrollBarWidth = window.innerWidth - document.body.clientWidth;

    if (modalBtn) {
      var modalClose = modalClass.querySelector(".modal__close");
      var modalOverlay = modalClass.querySelector(".overlay");
      var modalButtons = document.querySelectorAll(".modal__button");
...
function slickSlider() {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.experts-slider').slick({
      slidesToShow: 6,
      responsive: [{
        breakpoint: 1400,
        settings: {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.services-slider').slick({
      slidesToShow: 4,
      responsive: [{
        breakpoint: 1200,
        settings: {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.expert-slider').slick({
      slidesToShow: 3,
      responsive: [{
        breakpoint: 1201,
        settings: {
...
function spoiler() {
  function useSpoiler(btnSpoiler, wrapperSpoiler, overlaySpoiler) {
    var spoilerButton = document.querySelector(btnSpoiler);
    var spoilerWrapper = document.querySelector(wrapperSpoiler);
    var spoilerItems = document.querySelectorAll(".spoiler__item a"); // const spoilerOverlay = document.querySelector(overlaySpoiler);
    ...
    spoilerButton.addEventListener("click", function () {
      if (!spoilerWrapper.classList.contains("opened-spoiler")) {
        ...
        spoilerWrapper.classList.add("opened-spoiler"); // spoilerOverlay.style.display = "block";
      } else {
        spoilerWrapper.classList.remove("opened-spoiler");
        spoilerButton.classList.remove("active"); // spoilerOverlay.style.display = "";
      }
    });
    ...
    spoilerWrapper.addEventListener("click", function (event) {
...
function validate() {
  function validateTel() {
    ...
    var phoneInput = document.getElementById("telInput");
    phoneInput.addEventListener("input", function (e) {
      var ar = Array.from(e.target.value);
      var validPhone = true;

      for (var i = 0; i < ar.length && validPhone; i++) {
        var char = ar[i];

        switch (i) {
          case 0:
            if (char != "+") ar.splice(0, 0, "+");
            break;

          case 1:
            if (!isDigit(char)) validPhone = false;else if (ar[i + 1] != "(") ar.splice(i + 1, 0, "(");
            break;

          case 3:
          case 4:
            if (!isDigit(char)) validPhone = false;
            break;
      ...
      if (validPhone && ar.length == 16) e.target.value = ar.join('');
    });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_spoiler__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/spoiler */ "./src/js/modules/spoiler.js");
...
/* harmony import */ var _services_sendDataToServer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./services/sendDataToServer */ "./src/js/services/sendDataToServer.js");
/* harmony import */ var _modules_slickSlider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/slickSlider */ "./src/js/modules/slickSlider.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_services_sendDataToServer__WEBPACK_IMPORTED_MODULE_3__["default"])(); // validate();
  // smoothScroll();

  (0,_modules_slickSlider__WEBPACK_IMPORTED_MODULE_4__["default"])();
});

/***/ }),

/***/ "./src/js/services/sendDataToServer.js":
/*!*********************************************!*\
  !*** ./src/js/services/sendDataToServer.js ***!
  \*********************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = (sendDataToServer);
